...
* **Storage** : 결과물 공유를 위한 Volumes 설정 

<figure><img src="../../.gitbook/assets/storage-volume.png" alt=""><figcaption></figcaption></figure>
* **Volumes - Name**: `efs`
* **Volumes - Filesystem ID**: `fs-xxxxxxxxxxxxxxxx` EFS Console에서 file systemid를 찾아서 지정
...
* **Command**:​   N개의 노드에 분산학습을 할때 모델 트레이닝에 대한 결과 pt 파일을 efs에 공유하여 저장하고자 하는 경우 아래 커맨드로 설정해야 합니다. 
`[​
  "/bin/bash",​
  "-c",​
