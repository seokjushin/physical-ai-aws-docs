...
```bash
pip3 install zmq msgpack numpy 
...
```bash
  echo '#!/usr/bin/env python3' > /tmp/g.py                                                                                                                                  
  echo 'import zmq,msgpack,numpy as np,io' >> /tmp/g.py                                                                                                                      
  echo 'def enc(o):' >> /tmp/g.py                                                                                                                                            
  echo '  if isinstance(o,np.ndarray):' >> /tmp/g.py                                                                                                                         
  echo '    b=io.BytesIO();np.save(b,o,allow_pickle=False);return {"__ndarray_class__":True,"as_npy":b.getvalue()}' >> /tmp/g.py                                             
  echo '  return o' >> /tmp/g.py                                                                                                                                             
  echo 'def dec(o):' >> /tmp/g.py                                                                                                                                            
  echo '  if isinstance(o,dict) and "__ndarray_class__" in o: return np.load(io.BytesIO(o["as_npy"]),allow_pickle=False)' >> /tmp/g.py                                       
  echo '  return o' >> /tmp/g.py                                                                                                                                             
  echo 'c=zmq.Context()' >> /tmp/g.py                                                                                                                                        
  echo 's=c.socket(zmq.REQ)' >> /tmp/g.py                                                                                                                                    
  echo 's.connect("tcp://localhost:5555")' >> /tmp/g.py                                                                                                                      
  echo 's.send(msgpack.packb({"endpoint":"ping"}))' >> /tmp/g.py                                                                                                             
  echo 'print("Ping:",msgpack.unpackb(s.recv(),raw=False))' >> /tmp/g.py                                                                                                     
  echo 'v={"ego_view_bg_crop_pad_res256_freq20":np.random.randint(0,255,(1,1,256,256,3),dtype=np.uint8)}' >> /tmp/g.py                                                       
  echo 'st={}' >> /tmp/g.py                                                                                                                                                  
  echo 'st["left_arm"]=np.random.rand(1,1,7).astype(np.float32)' >> /tmp/g.py                                                                                                
  echo 'st["right_arm"]=np.random.rand(1,1,7).astype(np.float32)' >> /tmp/g.py                                                                                               
  echo 'st["left_hand"]=np.random.rand(1,1,6).astype(np.float32)' >> /tmp/g.py                                                                                               
  echo 'st["right_hand"]=np.random.rand(1,1,6).astype(np.float32)' >> /tmp/g.py                                                                                              
  echo 'st["waist"]=np.random.rand(1,1,3).astype(np.float32)' >> /tmp/g.py                                                                                                   
  echo 'la={"task":[["pick up the cup"]]}' >> /tmp/g.py                                                                                                                      
  echo 'obs={"video":v,"state":st,"language":la}' >> /tmp/g.py                                                                                                               
  echo 'req={"endpoint":"get_action","data":{"observation":obs}}' >> /tmp/g.py                                                                                               
  echo 's.send(msgpack.packb(req,default=enc))' >> /tmp/g.py                                                                                                                 
  echo 'r=msgpack.unpackb(s.recv(),raw=False,object_hook=dec)' >> /tmp/g.py                                                                                                  
  echo 'if isinstance(r,list):' >> /tmp/g.py                                                                                                                                 
  echo '  a=r[0];print("OK! Action keys:",list(a.keys()))' >> /tmp/g.py                                                                                                      
  echo '  [print(f"  {k}: {np.array(a[k]).shape}") for k in a]' >> /tmp/g.py                                                                                                 
  echo 'elif isinstance(r,dict) and "error" in r: print("ERR:",str(r["error"])[:300])' >> /tmp/g.py                                                                          
  echo 'else: print("Response:",type(r).__name__)' >> /tmp/g.py                                                                                                              
  python3 /tmp/g.py                                                                                                                                                          
                     
```

Ping: {'status': 'ok', 'message': 'Server is running'}
OK! Action keys: ['left_arm', 'right_arm', 'left_hand', 'right_hand', 'waist']
  left_arm: (1, 16, 7)
  right_arm: (1, 16, 7)
  left_hand: (1, 16, 6)
  right_hand: (1, 16, 6)
