...
cd ~/aws-physical-ai-recipes/isaac-lab-workshop/infra-multiuser-groot
...
```bash
cp -r ~/aws-physical-ai-recipes/isaac-lab-workshop/infra-groot-finetune /tmp/
cd /tmp/infra-groot-finetune
npm install
npx cdk deploy ...
```
