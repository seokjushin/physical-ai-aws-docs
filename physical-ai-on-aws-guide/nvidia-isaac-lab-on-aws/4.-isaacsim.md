...
* **best\_agent.pt**: [Module 3](3.-aws-batch.md)의 AWS Batch 분산 학습 실행 시 생성되는 체크포인트로, 학습 중 가장 좋은 성능을 보인 시점에 저장됩니다.
...
[Module 3](3.-aws-batch.md)에서 AWS Batch로 분산 학습한 결과를 검증합니다. Batch Job이 완료되면 EFS의 `/efs/models` 경로에 체크포인트가 저장되며, 이를 Docker 컨테이너에 마운트하여 추론을 실행합니다.
