...
### 4. Batch를 통해 각 컨테이너 노드에 마운트 하여 Batch Job이 완료된 결과 모델로 IsaacSim 실행 
...
​```
checkpoint 지정 시 디렉토리 유의해야 하며 docker file 내에 마운트될 때 /workspace/IsaacLab/TrainedModel 아래 마운트 되서 models/h1_rough/<date time _ppo_torch/checkpoints/best_agent.pt 형태로 job 완료시 모델 저장 ​
