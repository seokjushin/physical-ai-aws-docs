...
{% hint style="info" %}
`--dataset-path` 없이 실행하면 synthetic observation으로 closed-loop 구조를 테스트합니다. 완전한 closed-loop 시뮬레이션(Isaac Sim 환경에서 로봇 제어)은 [RL Track](5.-rl-training.md)의 Isaac Lab 환경에서 수행할 수 있습니다.
{% endhint %}
