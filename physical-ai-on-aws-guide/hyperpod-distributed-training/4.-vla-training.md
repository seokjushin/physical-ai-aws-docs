...
{% hint style="info" %}
Head node에는 GPU가 없으므로 `CUDA: False`가 정상입니다. Compute node에서는 `True`가 됩니다.
{% endhint %}
...
Max Steps: 2000
Batch Size: 2
Start: Sat May  3 12:00:00 UTC 2025
==================================================
...
🚀 Starting training...
  0%|          | 0/2000 [00:00<?, ?it/s]
 20%|██        | 1/5 [00:56<03:47, 56.99s/it]
...
Training completed!
{'train_runtime': 104.87, 'train_loss': 0.3192}
==================================================
Fine-tuning completed successfully
End: Sat May  3 12:02:00 UTC 2025
==================================================
```
...
**예상 출력:**
```
Model loaded from /fsx/checkpoints/vla/groot-demo_data/checkpoint-2000
Dataset: /fsx/scratch/Isaac-GR00T/demo_data/droid_sample (3 trajectories)

Trajectory 0: MSE=0.0012, steps=150
Trajectory 1: MSE=0.0015, steps=148
Trajectory 2: MSE=0.0011, steps=152

Mean MSE: 0.0013
```

MSE가 작을수록 학습이 잘 된 것입니다. 일반적으로 0.01 이하면 양호합니다.
