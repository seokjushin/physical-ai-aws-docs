...
2. 우측 상단 리전을 **US West (Oregon) `us-west-2`** 로 설정합니다.
...
| S3BucketName | osmo-data-osmo-123456789012-us-west-2 |
| VpcId | vpc-0xxxxxxxxxxxxxxxxx |
| OsmoDbEndpoint | osmo-postgres.xxx.us-west-2.rds.amazonaws.com |
| OsmoDbPort | 5432 |
| OsmoRedisEndpoint | osmo-redis.xxx.cache.amazonaws.com |
| OsmoRedisPort | 6379 |
| OsmoDbSecretArn | arn:aws:secretsmanager:us-west-2:... |
