...
cd ~/aws-physical-ai-recipes/physical-ai-e2e-workshop/infra/isaaclab
...
```bash
cp -r ~/aws-physical-ai-recipes/physical-ai-e2e-workshop/infra/groot-finetune /tmp/
cd /tmp/groot-finetune
npm install
npx cdk deploy ...
```
