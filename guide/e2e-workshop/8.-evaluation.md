...
> 🟦 **BEST NX1**: closed-loop 평가(IsaacSim GUI)는 [0. NX1 셀프 배포 가이드](0.-nx1-self-deploy.md)의 **DCV-over-SSM(Step 3)** 에서 실행합니다. 문서의 "SSH" 언급은 *SSH로는 렌더링이 안 된다*는 주의이며, NX1은 SSH 자체가 차단이니 **DCV**로 진행하세요.
