...
3. **Parameters**:
   ...
   | `StudioDomainId` | `<STUDIO_DOMAIN_ID>` | 강사가 채팅으로 확인. 기존 nx1 Studio 도메인 |
   ...
   | `MlflowTrackingServerName` | `<MLFLOW_TRACKING_SERVER>` (또는 강사 제공 값 그대로) | `nx1-groot-shared` Outputs에서도 확인 가능 |
